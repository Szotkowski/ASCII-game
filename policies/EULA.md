...
Please read this End-User License Agreement carefully before clicking the "I Agree" button, downloading or using ElderGlyph.
...
- __Agreement__ means this End-User License Agreement that forms the entire agreement between You and the Company regarding the use of the Application. This Agreement has been created with the help of the [EULA Generator](https://www.privacypolicies.com/eula-generator/).

- __Application__ means the software program provided by the Company downloaded by You to a Device, named ElderGlyph


- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ElderGlyph.
...
- By email: mikiszotkowski@protonmail.com